...
function movie_review_hub_enqueue_styles() {
    ...
    $film_maker_lite_tp_theme_css = '
        body{
            font-family: '.esc_html($film_maker_lite_body_font_family).'!important;
        }
        .readmore-btn a{
            font-family: '.esc_html($film_maker_lite_body_font_family).'!important;
        }
        h1{
            font-family: '.esc_html($film_maker_lite_heading_font_family).'!important;
        }
        h2{
            font-family: '.esc_html($film_maker_lite_heading_font_family).'!important;
        }
        ...
        .menubar{
            font-family: '.esc_html($film_maker_lite_menu_font_family).'!important;
        }
    ';
...
if ( ! defined( 'FILM_MAKER_LITE_PRO_THEME_URL' ) ) {
    define( 'FILM_MAKER_LITE_PRO_THEME_URL', esc_url('https://www.themespride.com/products/movie-streaming-wordpress-theme'));
}
if ( ! defined( 'FILM_MAKER_LITE_FREE_THEME_URL' ) ) {
	define( 'FILM_MAKER_LITE_FREE_THEME_URL', 'https://www.themespride.com/products/free-movie-review-wordpress-theme' );
}
if ( ! defined( 'FILM_MAKER_LITE_DEMO_THEME_URL' ) ) {
	define( 'FILM_MAKER_LITE_DEMO_THEME_URL', 'https://page.themespride.com/movie-review-hub-pro/' );
}
if ( ! defined( 'FILM_MAKER_LITE_DOCS_THEME_URL' ) ) {
    define( 'FILM_MAKER_LITE_DOCS_THEME_URL', 'https://page.themespride.com/demo/docs/movie-review-hub/' );
}
if ( ! defined( 'FILM_MAKER_LITE_DOC_URL' ) ) {
	define( 'FILM_MAKER_LITE_DOC_URL', esc_url('https://page.themespride.com/demo/docs/movie-review-hub/'));
}
...
define('MOVIE_REVIEW_HUB_CREDIT',__('https://www.themespride.com/products/free-movie-review-wordpress-theme','movie-review-hub') );

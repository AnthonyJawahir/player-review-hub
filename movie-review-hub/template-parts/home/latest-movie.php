...
<?php $movie_review_hub_static_image= get_stylesheet_directory_uri() . '/assets/images/sliderimage.png'; ?>
...
<section id="movie-time" class="py-5">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 align-self-center text-center text-md-end">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="cat-inner-box mb-4">
                <div class="image-icon">
                  <?php if(has_post_thumbnail()) { ?><?php the_post_thumbnail(); ?><?php }else {echo ('<img src="'.$movie_review_hub_static_image.'">'); } ?>
                  <div class="paly-icon">
                ...
                <div class="offer-box pt-2">
                  ...
                  <?php if( get_post_meta($post->ID, 'movie_review_hub_movie_time', true) ) {?>
                    <span><i class="far fa-play-circle me-2"></i><?php echo esc_html(get_post_meta($post->ID,'movie_review_hub_movie_time',true)); ?></span>
                  <?php }?>
                </div>
              </div>
            </div>
